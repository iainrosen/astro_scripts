...
#
# July 2023:
# Small changes to existing script in order to support FITS conversion from SPE with multiple frames
# Iain Rosen (iainrosen@uvic.ca)
...
def readSpe(spefilename, verbose=True):
    """ 
...
def speDictToFits(spedict, outfile=None, clobber=False, verbose=False):
    ...
    #for frameNumber in range( len(spedict['data']) ):
        ...
        for kk in hdrDesc.keys():
            ...
            hdu.header[kk] = (spedict[kk], hdrDesc[kk])
